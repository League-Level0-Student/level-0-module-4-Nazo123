...
public class HappyPet {
	...
	public static void main(String[] args) {
		...
		pet = JOptionPane.showInputDialog("What pet do you want to buy? A dog or a cat?");
		// 7. REPEAT steps 3 - 6 enough times to make your pet happy!
		
for (int i=0;1<4;i++) {
 String titel = happinessLevel+"";
			// 3. Use showOptionDialog to ask the user what they want to do to make their pet happy
			//    (eg: cuddle, food, water, take a walk, groom, clean up poop).
			//    Make sure to customize the title and question too.
			task = JOptionPane.showOptionDialog(null, "What do you want to do to your pet to make it happier?", titel, 0, JOptionPane.INFORMATION_MESSAGE, null,
